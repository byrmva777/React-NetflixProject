...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between pt-5 w-full"> 
      <img className="w-[150px]" src="https://upload.wikimedia.org/wikipedia/commons/7/7a/Logonetflix.png" alt="Netflix logo" />
      
      <div className="flex items-center gap-4 h-[40px]">
      import React from "react";

    <div className="relative w-auto min-w-[150px] max-w-[250px] transform translate-x-[13px]">
        ...
        <button onClick={()=> {navigate("/login")}} className="bg-[rgb(229,9,20)] hover:bg-[#ce272ffb] transition duration-100 ease-in px-6 py-1 text-lg text-white font-semibold rounded-[4px]">
          Sign In
        </button>
      </div>
    </div>
